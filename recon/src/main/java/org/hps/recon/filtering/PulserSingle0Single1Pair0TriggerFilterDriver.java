 ...
 *
 */
public class PulserSingle0Single1Pair0TriggerFilterDriver extends Driver
{
  public void process(EventHeader event) {
    ...
    for (GenericObject gob : event.get(GenericObject.class,"TriggerBank"))
    {
      ...
      if (tid.isSingle0Trigger() || tid.isPair0Trigger() || tid.isPulserTrigger() || tid.isSingle1Trigger()) return;
    }
